...
public class SkyBlockChunkGenerator extends ChunkGenerator {
    ...
    private static void generateStrongholdPortal(ServerWorldAccess world, BlockPos pos, long seed) {
        ...
        placeRelativeBlock(world, northPortalFrame.with(EndPortalFrameBlock.EYE, eyes[5]), pos, 6, 3, 12);
        placeRelativeBlock(world, eastPortalFrame.with(EndPortalFrameBlock.EYE, eyes[6]), pos, 3, 3, 9);
        placeRelativeBlock(world, eastPortalFrame.with(EndPortalFrameBlock.EYE, eyes[7]), pos, 3, 3, 10);
        placeRelativeBlock(world, eastPortalFrame.with(EndPortalFrameBlock.EYE, eyes[8]), pos, 3, 3, 11);
        placeRelativeBlock(world, westPortalFrame.with(EndPortalFrameBlock.EYE, eyes[9]), pos, 7, 3, 9);
        placeRelativeBlock(world, westPortalFrame.with(EndPortalFrameBlock.EYE, eyes[10]), pos, 7, 3, 10);
